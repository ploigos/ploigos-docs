...
| Static Code Analysis
| The pipeline will perform static analysis on source code to catch defects, vulnerabilities, programmatic and stylistic problems as early in the development lifecycle as possible, prior to deploying and running the code.
|
