...
Each predefined processes represents an encapsulation of work that is typically necessary in the assembly of a complete end-to-end pipeline  
...
| Prioritize Ideas
| Move idea from a person's head, into the backlog of items that a developer will implement. Must go through proper vetting, and a work item created (in work management tool) that can track item through to completion.     
| Define work items to bring idea to reality Cost and track work items using work tracking tool of choice 
