...
[id="{ProjectNameID}"]
= {ProjectName} - Customize Workflow
:context: assembly-{ProjectNameID}

include::modules/con-ploigos-customize-opinions-establish.adoc[leveloffset=+1]
include::modules/proc-ploigos-customize-opinions-formation.adoc[leveloffset=+1]
include::modules/proc-ploigos-customize-workflow.adoc[leveloffset=+1]
include::modules/proc-ploigos-customize-steprunner.adoc[leveloffset=+1]
include::modules/proc-ploigos-customize-container.adoc[leveloffset=+1]
