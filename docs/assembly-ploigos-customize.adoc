...
include::modules/customize/con-ploigos-customize-opinions-establish.adoc[leveloffset=+1]
include::modules/customize/proc-ploigos-customize-opinions-formation.adoc[leveloffset=+1]
